...
const CONFIG = {
  ...
  ASSET_RANKS: [
    ...
    { min: 250000, name: "県一周レベル", km: 625, icon: "map", bg: "rank-bg-pref.jpg" },
    { min: 600000, name: "四国一周レベル", km: 1600, icon: "island", bg: "rank-bg-shikoku.jpg" },
    { min: 1400000, name: "北海道一周レベル", km: 3000, icon: "island", bg: "rank-bg-hokkaido.jpg" },
